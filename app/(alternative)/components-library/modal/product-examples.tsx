          ...
          <ModalAction isOpen={newsletterModalOpen} setIsOpen={setNewsletterModalOpen}>
            ...
            <div className="text-center">
              <div className="text-sm mb-6">
                Semper eget duis at tellus at urna condimentum mattis pellentesque lacus suspendisse
                faucibus interdum.
              </div>
              {/* Submit form */}
        ...
        <div className="m-1.5">
          ...
          <ModalAction isOpen={integrationModalOpen} setIsOpen={setIntegrationModalOpen}>
            ...
            <div className="mb-5 text-center">
              ...
              <div className="text-lg font-semibold text-gray-800 dark:text-gray-100">
                Connect Thrive with your Cruip account
              </div>
            </div>
            {/* Modal content */}
            <div className="text-sm mb-5">
              <div className="font-medium text-gray-800 dark:text-gray-100 mb-3">
                Thrive would like to:
              </div>
              ...
              <div className="text-xs text-gray-500">
                By clicking on Allow access, you authorize Thrive to use your information in
                accordance with its{' '}
                <a
                ...
                . You can stop it at any time on the integrations page of your Thrive account.
              </div>
            </div>
            {/* Modal footer */}
            <div className="flex flex-wrap justify-end space-x-2">
            ...
            <div className="p-5">
              ...
              <div className="text-sm mb-5">
                <div className="space-y-2">
                  <p>
                    You might not be aware of this fact, but every frame, digital video, canvas,
                    responsive design, and image often has a rectangular shape that is exceptionally
                    precise in proportion (or ratio).
                  </p>
                  <p>
                    The ratio has to be well-defined to make shapes fit into different and distinct
                    mediums, such as computer, movies, television and camera screens.
                  </p>
                </div>
              </div>
              {/* Modal footer */}
          ...
          <ModalBasic isOpen={planModalOpen} setIsOpen={setPlanModalOpen} title="Change your Plan">
            ...
            <div className="px-5 pt-4 pb-1">
              <div className="text-sm">
                ...
                <div className="text-xs text-gray-500">
                  Your workspace's Thrive Light Plan is set to $39 per month and will renew on
                  August 9, 2024.
                </div>
              </div>
            </div>
