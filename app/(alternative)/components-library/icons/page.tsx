        ...
        <div>
          ...
          <div className="space-y-8 mt-8">
            <div className="text-sm">
              If you need more icons than what we currently support in Thrive, check out these great
              packs 👇
            </div>
            ...
            <div>
              ...
              <div className="px-6 py-8 bg-gray-100 dark:bg-gray-800/50 rounded-lg text-center xl:text-left xl:flex xl:flex-wrap xl:justify-between xl:items-center">
                <div className="text-gray-900 dark:text-gray-100 mb-4 xl:mb-0 max-w-lg mx-auto xl:mx-0 2xl:max-w-none">
                  99% of the icons used in Thrive come from Nucleo; a huge library of 3K+ vector
                  icons!
                </div>
            ...
            <div>
              ...
              <div className="px-6 py-8 bg-gray-100 dark:bg-gray-800/50 rounded-lg text-center xl:text-left xl:flex xl:flex-wrap xl:justify-between xl:items-center">
                <div className="text-gray-900 dark:text-gray-100 mb-4 xl:mb-0 max-w-lg mx-auto xl:mx-0 2xl:max-w-none">
                  A set of 1250+ icons that are visually consistent with the style used in Thrive!
                </div>
                <div className="inline-flex space-x-3">
                  <a
                    className="btn bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-gray-800 dark:text-gray-300"
