DO $$ BEGIN
  IF NOT EXISTS (
    ...
    WHERE table_name = 'work_item_attachments' AND column_name = 'work_item_field_id'
  ) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    WHERE constraint_name = 'work_item_attachments_work_item_field_id_work_item_fields_'
