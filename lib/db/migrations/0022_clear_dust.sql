...
CREATE INDEX "idx_work_item_field_values_work_item_field" ON "work_item_field_values" USING btree ("work_item_id","work_item_field_id");--> statement-breakpoint
...
CREATE INDEX "idx_unique_transition" ON "work_item_status_transitions" USING btree ("work_item_type_id","from_status_id","to_status_id");--> statement-breakpoint
...
CREATE INDEX "idx_unique_watcher" ON "work_item_watchers" USING btree ("work_item_id","user_id");--> statement-breakpoint
...
CREATE INDEX "idx_work_items_path" ON "work_items" USING btree ("path");--> statement-breakpoint
...
CREATE INDEX "idx_webauthn_credentials_user_active" ON "webauthn_credentials" USING btree ("user_id","is_active");