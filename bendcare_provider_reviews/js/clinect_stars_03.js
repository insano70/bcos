...
;(function($, window, document, undefined) {
    ...
    $.extend(Plugin.prototype, {
        ...
        loadProviderScore: function(provider_id) {
            ...
            var $star_container = $("<div>", {id: "star-container-"+this.settings.providerId, class: this.settings.size + " star-container"});
            ...
            var $range_tooltip = $("<span>",{id: "range_tooltip-"+this.settings.providerId, class: "tooltiptext"});

            $star_background.appendTo($star_container);
            $score_overlay.appendTo($star_background);

            var $ratings_reviews_block = $("<div>",{id: "ratings-reviews-block-"+this.settings.providerId, class: this.settings.size + " clinect-ratings-reviews-block"});
            var $star_qty = $("<div>",{id: "star-qty-"+this.settings.providerId, class: this.settings.size + " clinect-star-qty", "text":"0 stars"});
            var $reviews_qty = $("<span>",{id: "reviews-qty-"+this.settings.providerId, class: this.settings.size + " clinect-reviews-qty", "text":"0 reviews"});
            var $rating_qty = $("<span>",{id: "rating-qty-"+this.settings.providerId, class: this.settings.size + " clinect-rating-qty", "text":"0 ratings, "});
        ...
        updateScoreOverlay: function(provider_id,response_count,curated_response_count,score_value) {
            //debugger;
            ...
            $("#"+$(this.element).attr('id') + " #"+"rating-qty-"+provider_id).text(response_count.toLocaleString() + " ratings, ");
            $("#"+$(this.element).attr('id') + " #"+"reviews-qty-"+provider_id).text(curated_response_count.toLocaleString() + " reviews");
            ...
            if(this.settings.showTooltip) {
                ...
                $("#" + $(this.element).attr('id') + " #" + "star-qty-" + provider_id).text(rating_range_text);
            }
