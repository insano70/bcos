...
describe('ColumnMappingService', () => {
  ...
  describe('getMapping()', () => {
    it('should resolve column mapping for Data Source 1', async () => {
      ...
      vi.mocked(chartConfigService.getDataSourceConfigById).mockResolvedValue({
        ...
        isActive: true,
        columns: [
          { id: 1, columnName: 'date_index', isDateField: true, isTimePeriod: false, isMeasure: false, isDimension: true, displayName: 'Date', dataType: 'date', isFilterable: true, isGroupable: false, sortOrder: 1 },
          { id: 2, columnName: 'measure_value', isDateField: false, isTimePeriod: false, isMeasure: true, isDimension: false, displayName: 'Value', dataType: 'numeric', isFilterable: false, isGroupable: false, sortOrder: 2 },
          { id: 3, columnName: 'measure_type', isDateField: false, isTimePeriod: false, isMeasure: false, isDimension: true, isMeasureType: true, displayName: 'Type', dataType: 'text', isFilterable: true, isGroupable: false, sortOrder: 3 },
          { id: 4, columnName: 'frequency', isDateField: false, isTimePeriod: true, isMeasure: false, isDimension: true, displayName: 'Frequency', dataType: 'text', isFilterable: true, isGroupable: true, sortOrder: 4 },
          { id: 5, columnName: 'practice_uid', isDateField: false, isTimePeriod: false, isMeasure: false, isDimension: true, displayName: 'Practice', dataType: 'integer', isFilterable: true, isGroupable: true, sortOrder: 5 },
          { id: 6, columnName: 'provider_uid', isDateField: false, isTimePeriod: false, isMeasure: false, isDimension: true, displayName: 'Provider', dataType: 'integer', isFilterable: true, isGroupable: true, sortOrder: 6 },
        ],
      });
    ...
    it('should resolve column mapping for Data Source 3', async () => {
      ...
      vi.mocked(chartConfigService.getDataSourceConfigById).mockResolvedValue({
        ...
        isActive: true,
        columns: [
          { id: 1, columnName: 'date_value', isDateField: true, isTimePeriod: false, isMeasure: false, isDimension: true, displayName: 'Date', dataType: 'date', isFilterable: true, isGroupable: false, sortOrder: 1 },
          { id: 2, columnName: 'numeric_value', isDateField: false, isTimePeriod: false, isMeasure: true, isDimension: false, displayName: 'Value', dataType: 'numeric', isFilterable: false, isGroupable: false, sortOrder: 2 },
          { id: 3, columnName: 'measure_type', isDateField: false, isTimePeriod: false, isMeasure: false, isDimension: true, isMeasureType: true, displayName: 'Type', dataType: 'text', isFilterable: true, isGroupable: false, sortOrder: 3 },
          { id: 4, columnName: 'time_period', isDateField: true, isTimePeriod: true, isMeasure: false, isDimension: true, displayName: 'Period', dataType: 'text', isFilterable: true, isGroupable: true, sortOrder: 4 },
          { id: 5, columnName: 'practice_uid', isDateField: false, isTimePeriod: false, isMeasure: false, isDimension: true, displayName: 'Practice', dataType: 'integer', isFilterable: true, isGroupable: true, sortOrder: 5 },
          { id: 6, columnName: 'provider_uid', isDateField: false, isTimePeriod: false, isMeasure: false, isDimension: true, displayName: 'Provider', dataType: 'integer', isFilterable: true, isGroupable: true, sortOrder: 6 },
        ],
      });
    ...
    it('should throw error for missing required date column', async () => {
      vi.mocked(chartConfigService.getDataSourceConfigById).mockResolvedValue({
        ...
        columns: [
          // Missing date field!
          { id: 2, columnName: 'measure_value', isDateField: false, isTimePeriod: false, isMeasure: true, isDimension: false, displayName: 'Value', dataType: 'numeric', isFilterable: false, isGroupable: false, sortOrder: 1 },
        ],
      });
    ...
    it('should cache mapping after first load', async () => {
      vi.mocked(chartConfigService.getDataSourceConfigById).mockResolvedValue({
        ...
        columns: [
          { id: 1, columnName: 'date_index', isDateField: true, isTimePeriod: false, isMeasure: false, isDimension: true, displayName: 'Date', dataType: 'date', isFilterable: true, isGroupable: false, sortOrder: 1 },
          { id: 2, columnName: 'measure_value', isDateField: false, isTimePeriod: false, isMeasure: true, isDimension: false, displayName: 'Value', dataType: 'numeric', isFilterable: false, isGroupable: false, sortOrder: 2 },
          { id: 3, columnName: 'measure_type', isDateField: false, isTimePeriod: false, isMeasure: false, isDimension: true, displayName: 'Type', dataType: 'text', isFilterable: true, isGroupable: false, sortOrder: 3 },
          { id: 4, columnName: 'frequency', isDateField: false, isTimePeriod: true, isMeasure: false, isDimension: true, displayName: 'Frequency', dataType: 'text', isFilterable: true, isGroupable: true, sortOrder: 4 },
        ],
      });
    ...
    it('should maintain separate cache entries for different data sources', async () => {
      ...
      const mockDS3 = {
        ...
        columns: [
          ...
          { id: 2, columnName: 'numeric_value', isDateField: false, isTimePeriod: false, isMeasure: true, isDimension: false, displayName: 'Value', dataType: 'numeric', isFilterable: false, isGroupable: false, sortOrder: 2 },
          { id: 3, columnName: 'measure_type', isDateField: false, isTimePeriod: false, isMeasure: false, isDimension: true, displayName: 'Type', dataType: 'text', isFilterable: true, isGroupable: false, sortOrder: 3 },
          { id: 4, columnName: 'time_period', isDateField: false, isTimePeriod: true, isMeasure: false, isDimension: true, displayName: 'Period', dataType: 'text', isFilterable: true, isGroupable: true, sortOrder: 4 },
        ],
      };
  ...
  describe('createAccessors()', () => {
    it('should create multiple accessors efficiently', async () => {
      ...
      const rows = [
        { date_index: '2025-01-01', measure_value: 100, measure_type: 'currency', frequency: 'Monthly' },
        { date_index: '2025-02-01', measure_value: 200, measure_type: 'currency', frequency: 'Monthly' },
        { date_index: '2025-03-01', measure_value: 300, measure_type: 'currency', frequency: 'Monthly' },
      ];
