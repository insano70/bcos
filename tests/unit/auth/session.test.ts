...
describe('session authentication logic', () => {
  ...
  describe('validateTokenAndGetUser', () => {
    ...
    it('should throw error for invalid token', async () => {
      ...
      await expect(validateTokenAndGetUser(mockToken)).rejects.toThrow('Authentication required');
    });
  ...
  describe('requireTokenRole', () => {
    ...
    it('should throw error for insufficient role', async () => {
      ...
      await expect(requireTokenRole(mockToken, allowedRoles)).rejects.toThrow(
  ...
  describe('requireTokenAdmin', () => {
    ...
    it('should throw error for non-admin role', async () => {
      ...
      await expect(requireTokenAdmin(mockToken)).rejects.toThrow(
        'Access denied. Required role: admin'
      );
    });
  });
  ...
  describe('requireTokenPracticeAccess', () => {
    ...
    it('should deny practice owner access to different practice', async () => {
      ...
      await expect(requireTokenPracticeAccess(mockToken, practiceId)).rejects.toThrow(
