...
describe('safe-json', () => {
  describe('safeJsonParse', () => {
    ...
    it('should handle complex nested objects', () => {
      ...
      const jsonString = '{"user": {"name": "John", "age": 30}, "settings": ["theme", "notifications"]}'
  ...
  describe('parseServices', () => {
    it('should parse valid services array', () => {
      const jsonString = '[{"name": "Consultation", "description": "Initial consultation"}, {"name": "Treatment"}]'
  ...
  describe('parseInsuranceAccepted', () => {
    it('should parse valid insurance array', () => {
      const jsonString = '[{"name": "Blue Cross", "accepted": true}, {"name": "Aetna", "accepted": false}]'
  ...
  describe('parseConditionsTreated', () => {
    it('should parse valid conditions array', () => {
      const jsonString = '[{"name": "Arthritis", "description": "Joint inflammation"}, {"name": "Back Pain"}]'
  ...
  describe('parseGalleryImages', () => {
    it('should parse valid gallery images', () => {
      const jsonString = '[{"url": "https://example.com/image.jpg", "alt": "Office", "caption": "Our office"}]'
  ...
  describe('parseEducation', () => {
    it('should parse valid education array', () => {
      const jsonString = '[{"degree": "MD", "school": "Harvard Medical", "year": "2010"}, {"degree": "BS", "school": "MIT", "year": "2006"}]'
