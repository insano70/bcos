...
describe('color-utils', () => {
  ...
  describe('generateSSRColorStyles', () => {
    ...
    it('should generate opacity variants', () => {
      ...
      expect((styles as Record<string, string>)['--color-primary-50']).toBe(
        'rgba(33, 116, 234, 0.05)'
      );
      expect((styles as Record<string, string>)['--color-primary-100']).toBe(
        'rgba(33, 116, 234, 0.1)'
      );
      expect((styles as Record<string, string>)['--color-primary-200']).toBe(
        'rgba(33, 116, 234, 0.2)'
      );
    });
