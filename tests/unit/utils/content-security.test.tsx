...
describe('content-security utilities', () => {
  ...
  describe('sanitizeEmail', () => {
    ...
    it('should limit length to 255 characters', () => {
      ...
      const _expected = `${'a'.repeat(250)}@example.co`; // Limited to 255 chars
  ...
  describe('sanitizeBioContent', () => {
    ...
    it('should handle complex script removal', () => {
      const complexScript =
        'Content <script type="text/javascript">alert("xss")</script> more content';
  ...
  describe('sanitizePhoneNumber', () => {
    ...
    it('should limit length to 20 characters', () => {
      ...
      const _expected = '+1 555-123-4567 exte'; // Limited to 20 chars
    ...
    it('should preserve valid phone number formats', () => {
      const validFormats = ['+1234567890', '123-456-7890', '(123) 456-7890', '123.456.7890'];
