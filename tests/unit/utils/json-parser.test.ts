...
describe('json-parser utilities', () => {
  ...
  describe('parseBusinessHours', () => {
    it('should parse valid business hours JSON', () => {
      const jsonString =
        '{"monday": {"open": "08:00", "close": "16:00", "closed": false}, "tuesday": {"closed": true}}';
  ...
  describe('parseEducation', () => {
    it('should parse valid education array', () => {
      const jsonString =
        '[{"institution": "University A", "year": "2020"}, {"institution": "University B", "year": "2022"}]';
  ...
  describe('parseGalleryImages', () => {
    it('should parse valid gallery images array', () => {
      ...
      expect(result).toEqual(['/images/1.jpg', '/images/2.jpg', 'https://example.com/3.jpg']);
    });
    ...
    it('should handle complex image objects', () => {
      const jsonString =
        '[{"url": "/img1.jpg", "alt": "Image 1"}, {"url": "/img2.jpg", "alt": "Image 2"}]';
