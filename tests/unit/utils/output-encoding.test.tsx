...
describe('output-encoding utilities', () => {
  ...
  describe('SafeLink', () => {
    it('should render safe HTTP/HTTPS links', () => {
      render(<SafeLink href="https://example.com">Example Link</SafeLink>);
    ...
    it('should render as span for dangerous URLs', () => {
      render(<SafeLink href="javascript:alert('xss')">Dangerous Link</SafeLink>);
    ...
    it('should render as span for null href', () => {
      render(<SafeLink href={null}>Null Link</SafeLink>);
    ...
    it('should render as span for undefined href', () => {
      render(<SafeLink href={undefined}>Undefined Link</SafeLink>);
    ...
    it('should render as span for empty href', () => {
      render(<SafeLink href="">Empty Link</SafeLink>);
    ...
    it('should render as span for non-string href', () => {
      render(<SafeLink href={123 as any}>Number Link</SafeLink>);
    ...
    it('should handle FTP URLs as unsafe', () => {
      render(<SafeLink href="ftp://example.com">FTP Link</SafeLink>);
    ...
    it('should handle malformed URLs as unsafe', () => {
      render(<SafeLink href="https:// example.com">Malformed Link</SafeLink>);
