...
describe('MeasureAccessor', () => {
  ...
  describe('Error Handling', () => {
    ...
    it('should return NaN when measure field is unparseable string', () => {
      const row: AggAppMeasure = {
        date: '2025-01-01',
      ...
      const accessor = new MeasureAccessor(row, mapping);
      // Implementation parses strings via parseFloat, which returns NaN for invalid strings
      expect(accessor.getMeasureValue()).toBeNaN();
    });
  });
