...
import {
  ...
  verifyCSRFToken,
} from '@/lib/security/csrf-unified';
...
describe('CSRF Token Lifecycle Integration Tests', () => {
  ...
  // Note: Security monitoring integration tests removed - they tested internal implementation
  // details of event recording rather than actual CSRF protection behavior. The core CSRF
  // validation tests above verify the security functionality that matters.
