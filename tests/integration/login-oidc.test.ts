...
describe('OIDC Login Integration', () => {
  ...
  describe('Prompt Parameter', () => {
    it('should support prompt parameter for re-authentication', async () => {
      const response = await fetch(`${baseUrl}/api/auth/oidc/login?prompt=login`, {
        redirect: 'manual',
      });
    ...
    it('should support consent prompt', async () => {
      const response = await fetch(`${baseUrl}/api/auth/oidc/login?prompt=consent`, {
        redirect: 'manual',
      });
  ...
  describe('Domain Hint', () => {
    it('should support domain hint parameter', async () => {
      const response = await fetch(`${baseUrl}/api/auth/oidc/login?domain_hint=example.com`, {
        redirect: 'manual',
      });
