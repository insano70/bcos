/**
 * RBAC Data Sources Service Integration Tests
 *
 * Tests the Data Sources Service with real CRUD operations.
 */
...
describe('RBAC Data Sources Service - Integration Tests', () => {
  ...
  describe('createDataSource - Creation Operations', () => {
    it('should create data source with all required fields', async () => {
      ...
      const role = await createTestRole({
        name: 'ds_creator',
        permissions: [
          'data-sources:create:all' as PermissionName,
          'data-sources:read:all' as PermissionName,
        ],
      });
      await assignRoleToUser(user, mapDatabaseRoleToRole(role));
  ...
  describe('updateDataSource - Modification Operations', () => {
    it('should update data source successfully', async () => {
      ...
      const role = await createTestRole({
        name: 'ds_editor',
        permissions: [
          'data-sources:update:all' as PermissionName,
          'data-sources:read:all' as PermissionName,
        ],
      });
      await assignRoleToUser(user, mapDatabaseRoleToRole(role));
  ...
  describe('deleteDataSource - Deletion Operations', () => {
    it('should delete data source successfully', async () => {
      ...
      const role = await createTestRole({
        name: 'ds_deleter',
        permissions: [
          'data-sources:delete:all' as PermissionName,
          'data-sources:read:all' as PermissionName,
        ],
      });
      await assignRoleToUser(user, mapDatabaseRoleToRole(role));
