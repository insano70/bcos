 ...
 * ```
 */
export class CommittedOrganizationFactory extends BaseFactory<CommittedOrganization, CreateOrganizationOptions> {
  ...
  protected async cleanupFromDatabase(ids: string[]): Promise<void> {
    ...
    await this.db
      ...
      .where(inArray(organizations.organization_id, ids))
  }
