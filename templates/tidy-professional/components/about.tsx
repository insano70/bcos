          ...
          <div className="max-w-3xl mx-auto">
              ...
              <div className="bg-white rounded-lg shadow-sm p-8 mb-8 animate-fade-up">
                <div className="flex items-start space-x-4">
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 rounded-full flex items-center justify-center bg-practice-primary-100">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              ...
              <div className="bg-white rounded-lg shadow-sm p-6 animate-fade-up animate-delay-100">
                <div className="w-12 h-12 rounded-full flex items-center justify-center mb-4" bg-practice-primary-100>
                  <svg className="w-6 h-6" text-practice-primary fill="currentColor" viewBox="0 0 24 24">
