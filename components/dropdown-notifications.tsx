    ...
    <Menu as="div" className="relative inline-flex">
      {({ open }) => (
        <>
          ...
          <Transition
            as="div"
            className={`origin-top-right z-50 absolute top-full -mr-48 sm:mr-0 min-w-[20rem] bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 py-1.5 rounded-lg shadow-lg overflow-hidden mt-1 ${
