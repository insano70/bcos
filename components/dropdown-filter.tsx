...
export default function DropdownProfile({ align }: { align?: 'left' | 'right' }) {
  return (
    <Popover className="relative inline-flex">
      ...
      <Transition
        as="div"
        className={`origin-top-right z-10 absolute top-full left-0 right-auto min-w-[14rem] bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 pt-1.5 rounded-lg shadow-lg overflow-hidden mt-1 ${
