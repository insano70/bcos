    ...
    <div className={`min-w-fit ${sidebarExpanded ? 'sidebar-expanded' : ''}`}>
      ...
      >
        ...
        <div className="space-y-8">
          ...
          {/* Work group - Only show if user has work access */}
          {hasWorkAccess && (
            <div>
              <h3 className="text-xs uppercase text-gray-400 dark:text-gray-500 font-semibold pl-3">
                <span
          ...
          {/* Configure group - Only show if user has configure access */}
          {hasConfigureAccess && (
            <div>
            <h3 className="text-xs uppercase text-gray-400 dark:text-gray-500 font-semibold pl-3">
              <span
              ...
              <span className="lg:hidden lg:sidebar-expanded:block 2xl:block">Configure</span>
            </h3>
            <ul className="mt-3">
              {/* Configure */}
              ...
              {/* Experimental mode conditional sections */}
              {isExperimentalMode && (
                <>
                  {/* E-Commerce */}
                        ...
                        <>
                          ...
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center">
                                <svg
                                  className={`shrink-0 fill-current ${segments.includes('ecommerce') ? 'text-violet-500' : 'text-gray-400 dark:text-gray-500'}`}
                                  xmlns="http://www.w3.org/2000/svg"
                                  width="16"
                                  height="16"
                                  viewBox="0 0 16 16"
                  ...
                  {/* Messages */}
                  <li
                    className={`pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r ${segments.includes('messages') && 'from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]'}`}
                  >
                  ...
                  {/* Inbox */}
                  <li
                    className={`pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r ${segments.includes('inbox') && 'from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]'}`}
                  >
                  ...
                  {/* Campaigns */}
                  <li
                    className={`pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r ${segments.includes('campaigns') && 'from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]'}`}
                  >
