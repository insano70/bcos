  ...
  return (
    <div className="px-5 py-4 bg-gray-50 dark:bg-gray-800/50">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        {field.field_type === 'datetime' && (
                          <input
                            ...
                            value={fieldValue ? String(fieldValue).split('T')[0] : ''}
                            onChange={(e) => {
                              // Convert date to ISO datetime format with timezone
                              const isoDateTime = e.target.value ? `${e.target.value}T00:00:00.000Z` : null;
                              handleCustomFieldChange(isoDateTime);
                            }}
                            className={`form-input w-full text-sm ${fieldError ? 'border-red-500' : ''}`}
                          />
                        )}
        ...
        {/* Comments Preview - hide in edit mode */}
        {!isEditing && (
          <div>
          <h4 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
        ...
        {/* Attachments Preview - hide in edit mode */}
        {!isEditing && (
          <div>
          <h4 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
        ...
        {!isEditing && (
          <div className="lg:col-span-2 flex items-center gap-4 pt-2 border-t border-gray-200 dark:border-gray-700">
          <button
            type="button"
