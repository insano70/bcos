                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
                      Table displays all active columns from the data source. No measure selection
                      required.
                    </p>
                  </div>
                </div>
              </div>
            ) : chartConfig.chartType === 'dual-axis' ? null : (
              <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-md border border-blue-200 dark:border-blue-800">
                <div className="flex items-start">
                  <svg
                    className="w-5 h-5 text-blue-600 dark:text-blue-400 mr-2 mt-0.5 flex-shrink-0"
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
                      Individual measures are configured in the Advanced Options section below. Each
                      series can have its own measure and aggregation method.
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="mt-2 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-md">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
                          Stacked bars show each group (Provider, Practice, etc.) as a colored
                          segment in a single bar per time period. Select a Group By option to
              ...
              <div className="md:col-span-2 border-t border-gray-200 dark:border-gray-700 pt-6 mt-6">
                ...
                <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-md">
                  <p className="text-sm text-blue-700 dark:text-blue-300">
                    ℹ️ Dual-axis charts display two measures with independent y-axes. The primary
                    measure shows as bars on the left axis, and the secondary measure shows as a
                    line or bars on the right axis.
                  </p>
                </div>
              </div>
            )}
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        updateConfig('periodComparison', {
                          ...currentConfig,
                          comparisonType: e.target.value as
                            | 'previous_period'
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          updateConfig('periodComparison', {
                            ...currentConfig,
                            customPeriodOffset: parseInt(e.target.value, 10) || 1,
                          });
                        }}
                        className="w-full px-3 py-2 border border-blue-300 dark:border-blue-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                      />
