...
interface DeleteChartModalProps {
  ...
  chartName: string;
  chartId: string;
  onConfirm: (chartId: string) => Promise<void>;
}
...
export default function DeleteChartModal({ 
  ...
  return (
    <ModalBasic isOpen={isOpen} setIsOpen={setIsOpen} title="Delete Chart">
      <div className="px-5 py-4">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Are you sure you want to delete <strong>"{chartName}"</strong>? This action cannot be undone.
          </p>
        </div>
