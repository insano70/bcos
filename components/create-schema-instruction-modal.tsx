...
interface CreateSchemaInstructionModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
}

export default function CreateSchemaInstructionModal({
  isOpen,
  onClose,
  onSuccess,
}: CreateSchemaInstructionModalProps) {
              ...
              <form onSubmit={handleSubmit} className="px-4 sm:px-6 py-4">
                ...
                <div className="px-4 sm:px-6 py-4 border-t border-gray-200 dark:border-gray-700 mt-6 -mx-4 sm:-mx-6 -mb-4">
                  <div className="flex flex-wrap justify-end space-x-2">
                    ...
                    <button
                      type="submit"
                      disabled={isSubmitting || !title.trim() || !instruction.trim()}
