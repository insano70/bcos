...
export default function ChannelMenu() {
  ...
  return (
    <Menu as="div" className="relative">
      ...
      <Transition
        as="div"
        className="origin-top-right z-50 absolute top-full left-0 min-w-[15rem] bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 py-1.5 rounded-lg shadow-lg overflow-hidden mt-1"
              ...
              {({ active }) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <svg
                      className={`w-3 h-3 shrink-0 fill-current text-violet-500 ml-1 ${option.id !== selected && 'invisible'}`}
                      viewBox="0 0 12 12"
                    >
