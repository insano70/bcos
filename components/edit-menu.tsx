    ...
    <Menu as="div" className={`relative inline-flex ${className}`}>
      {({ open }) => (
        <>
          ...
          <Transition
            as="div"
            className={`origin-top-right z-50 absolute top-full min-w-[9rem] bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 py-1.5 rounded-lg shadow-lg overflow-hidden mt-1 ${align === 'right' ? 'right-0' : 'left-0'}`}
