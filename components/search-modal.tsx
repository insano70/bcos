...
export default function SearchModal({ isOpen, setIsOpen }: SearchModalProps) {
  ...
  return (
    <Modal
      ...
      size="lg"
      containerClassName="items-start top-20 mt-0"
      className="border border-transparent dark:border-gray-700/60 shadow-lg"
    >
            {/* Search form */}
                ...
                <ul className="text-sm">
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span>Access Thrive on mobile and TV</span>
                    </Link>
                  </li>
                  <li>
                    <Link
